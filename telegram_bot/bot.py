...
from telegram_bot.handlers.onboarding_v2 import (
    ...
    get_country, get_name, get_can_run_5k, get_race,
    get_custom_dist, get_custom_hills, get_custom_date,
    get_vo2x_input,
    ...
    get_location,
    COUNTRY, NAME, CAN_RUN_5K, RACE_SELECT, CUSTOM_DIST, CUSTOM_HILLS, CUSTOM_DATE,
    EXPERIENCE, RECENT_DIST, RECENT_TIME, BEGINNER_ABILITY,
    WEEKLY_KM, LONGEST_RUN, PLAN_TYPE, LOCATION, VO2X_INPUT,
...
def build_application() -> Application:
    ...
    onboarding_conv = ConversationHandler(
        ...
        states={
            ...
            CAN_RUN_5K:       [MessageHandler(TEXT, get_can_run_5k)],
            ...
            VO2X_INPUT:       [MessageHandler(TEXT, get_vo2x_input)],
        },
